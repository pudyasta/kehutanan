          ...
          <div className="flex flex-col lg:flex-row items-center lg:my-[200px] my-[100px]">
            ...
            <div className="flex flex-col mt-6 lg:mt-0 lg:ml-[53px]">
              ...
              <p className="mt-3 font-sans text-justify">
                ...
                Penyelamatan Alam (ARuPA), Prodi Pengelolaan Hutan Sekolah
                Vokasi UGM, dan Samdhana Institut sebagai salah satu upaya untuk
                menjawab tantangan perjalanan kepengurusan hutan Jawa saat ini
                tatkala berada pada masa transisi Pemerintahan Indonesia hingga
                Oktober 2024 menuju pemerintahan baru. Pelaksanaan kegiatan
                bertepatan dengan Hari Lingkungan Hidup Sedunia tanggal 5 Juni
                2024.
              </p>
            </div>
          </div>
